...
func TestParseDuration(t *testing.T) {
	...
	tests := []struct {
		...
		{"zero then nonzero", "0s 1ms", 0, true},
		{"nonzero then zero", "1h 0s", 0, true},
		{"zero second unit", "1d 0h", 0, true},
		{"zero millisecond", "0ms", 0, true},
		{"leading zero zero", "00s", 0, true},
		{"negative leading zero zero", "-00s", 0, true},
		{"leading zero second part", "1d 000001µs", 0, true},
